...
Run5_sex = pd.read_csv("./results22/Run5_sex.csv")
Run4_sex = pd.read_csv("./results19/Run4_sex.csv")
Run3_sex = pd.read_csv("./results38/Run3_sex.csv")
Run2_sex = pd.read_csv("./results47/Run2_sex.csv")
Run1_sex = pd.read_csv("./results31/Run1_sex.csv")

Run5_Age = pd.read_csv("./results22/Run5_Age.csv")
Run4_Age = pd.read_csv("./results19/Run4_Age.csv")
Run3_Age = pd.read_csv("./results38/Run3_Age.csv")
Run2_Age = pd.read_csv("./results47/Run2_Age.csv")
Run1_Age = pd.read_csv("./results31/Run1_Age.csv")

Run5_race = pd.read_csv("./results22/Run5_race.csv")
Run4_race = pd.read_csv("./results19/Run4_race.csv")
Run3_race = pd.read_csv("./results38/Run3_race.csv")
Run2_race = pd.read_csv("./results47/Run2_race.csv")
Run1_race = pd.read_csv("./results31/Run1_race.csv")

Run5_insurance = pd.read_csv("./results22/Run5_insurance.csv")
Run4_insurance = pd.read_csv("./results19/Run4_insurance.csv")
Run3_insurance = pd.read_csv("./results38/Run3_insurance.csv")
Run2_insurance = pd.read_csv("./results47/Run2_insurance.csv")
Run1_insurance = pd.read_csv("./results31/Run1_insurance.csv")
...
plt.legend()
plt.grid(True)
plt.savefig("./results/INSURANCE.pdf")
