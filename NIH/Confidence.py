...
Run1_sex = pd.read_csv("./results33/Run1_sex.csv")
Run2_sex = pd.read_csv("./results96/Run2_sex.csv")
Run3_sex = pd.read_csv("./results60/Run3_sex.csv")
Run4_sex = pd.read_csv("./results37/Run4_sex.csv")
Run5_sex = pd.read_csv("./results3/Run5_sex.csv")
...
plt.legend()
plt.grid(True)
plt.savefig("./results/SEX_NIH.pdf")
#
# #---------------------------------------------------   Age



Run1_Age = pd.read_csv("./results33/Run1_Age.csv")
Run2_Age = pd.read_csv("./results96/Run2_Age.csv")
Run3_Age = pd.read_csv("./results60/Run3_Age.csv")
Run4_Age = pd.read_csv("./results37/Run4_Age.csv")
Run5_Age = pd.read_csv("./results3/Run5_Age.csv")
...
plt.legend()
plt.grid(True)
plt.savefig("./results/AGE_NIH.pdf")
